            ...
            <div className={styles.flexWrapperSix}>
                ...
                <div className={styles.relativeWrapperSeven}>
                    ...
                    <div className={styles.flexWrapperFourteen}>
                        ...
                        />
                        <div
                        className={styles.relativeWrapperThree}
                        >
                        <img
                            alt=""
                    ...
                    <div className={styles.relativeWrapperTwo}>
                        ...
                        >
                            ...
                            <div
                                className={styles.flexWrapperTwo}
                            >
                                <img
                                alt=""
                        ...
                        <img
                            alt=""
                            src="https://via.placeholder.com/0x0.09"
                        />
                        </div>
                        <img
                        alt=""
                ...
                <p className={styles.label3}>
                    Sign up for free and start using our services
                    immediately!
                </p>
                </div>
                ...
                <div className={styles.flexWrapperThirteen}>
                    ...
                    <p
                    className={
                        styles.iAgreeToEventablesTermsOfService
                    }
                    >
                    <strong
                        className={
                        styles.iAgreeToEventablesTermsOfServiceEmphasis0
                        }
                    >
